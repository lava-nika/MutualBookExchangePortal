...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("admin", pwEncoder.encode("abhi"), "f20181042@hyderabad.bits-pilani.ac.in", "Athul", "Bhai", "Budh Bhawan 354", "9074905582", "Hyderabad");
			user1.setRole("ROLE_ADMIN");
			
			User user2 = new User("ADMIN", pwEncoder.encode("gary"), "gary@gamail.com", "Athul", "B", "bits", "06-87054875", "Hyderabad");
